...
Particles.prototype = {
    update: function(timeDelta) {
        ...
        this.xVariance = this.object.atachToCam ? variance(settings.screen[0]/2) : this.object.xVariance ? variance(this.object.xVariance) : this.tween_xVariance.variance(timeDelta);
        this.yVariance = this.object.atachToCam ? variance(settings.screen[1]/2) : this.object.yVariance ? variance(this.object.yVariance) : this.tween_yVariance.variance(timeDelta);
